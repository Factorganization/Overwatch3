...
namespace Plugins.FishNet.Runtime.Managing.Transporting
{
    ...
    public sealed partial class TransportManager : MonoBehaviour
    {
        ...
        private void TryAddDefaultTransport()
        {
            if (Transport == null && !gameObject.TryGetComponent(out Transport))
                Transport = gameObject.AddComponent<global::Plugins.FishNet.Runtime.Transporting.Transports.Tugboat.Tugboat>();
        }
