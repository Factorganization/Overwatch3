...
using Plugins.FishNet.Runtime.Managing.Client.Object;
...
using Plugins.FishNet.Runtime.Transporting.Transports.Multipass;
using UnityEngine;

namespace Plugins.FishNet.Runtime.Managing.Client
{
    /// <summary>
