...
namespace Plugins.FishNet.Runtime.Managing.Timing.Editor
{
    ...
    public class TimeManagerEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.indentLevel++;
            if (_physicsMode.intValue == (int)global::Plugins.FishNet.Runtime.Managing.Timing.PhysicsMode.TimeManager)
