...
using UnityEngine;
using TimeManagerCls = Plugins.FishNet.Runtime.Managing.Timing.TimeManager;

namespace Plugins.FishNet.Runtime.Generated.Component.NetworkAnimator
{
    ...
    public sealed class NetworkAnimator : NetworkBehaviour
    {
        ...
        [Range(1, NetworkTransform.NetworkTransform.MAX_INTERPOLATION)]
        [SerializeField]
