    ...
    public partial class NetworkObject : MonoBehaviour
    {
        ...
        private void InvokeStartCallbacks(bool asServer, bool invokeSyncTypeCallbacks)
        {
            ...
            if (asServer)
            {
                ...
                for (int i = 0; i < NetworkBehaviours.Count; i++)
                    NetworkBehaviours[i].OnOwnershipServer_Internal(global::Plugins.FishNet.Runtime.Managing.NetworkManager.EmptyConnection);
            }
            //As client.
            else
            {
                ...
                for (int i = 0; i < NetworkBehaviours.Count; i++)
                    NetworkBehaviours[i].OnOwnershipClient_Internal(global::Plugins.FishNet.Runtime.Managing.NetworkManager.EmptyConnection);
            }
